...
void menu_autofire::populate()
{
    ...
    for (const auto &btn : buttons)
    {
        ...
        btn.field->get_user_settings(settings);
				...
				{
					case 0:	subtext.assign("关闭");	break;
					case 1:	subtext.assign("开启");	break;
					case 2:	subtext.assign("切换");	break;
				}
...
//				entry[menu_items] = field;
				...
				switch (settings.autofire)
				{
					case 0: subtext.assign(_("autofire", "关闭")); break;
					case 1: subtext.assign(_("autofire", "开启")); break;
					case 2: subtext.assign(_("autofire", "切换")); break;
				}

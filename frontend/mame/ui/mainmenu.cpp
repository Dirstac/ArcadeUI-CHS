...
#include "ui/menu_ips_patches.h"	//缘来是你
...
void menu_main::populate()
{
	...
	//缘来是你 添加 IPS Patches 菜单项
    item_append(_("menu-main", "IPS 管理器"), 0, (void *)IPS_PATCHES);
...
// 缘来是你 MAMEP
/*******************************************************************************/
	item_append(_("menu-main", "连射设置"), 0, (void *)AUTOFIRE);
#ifdef USE_CUSTOM_BUTTON
	item_append(_("menu-main", "自定义设置"), 0, (void *)CUSTOM_BUTTON_SETTING);
	item_append(_("menu-main", "自定义按键"), 0, (void *)CUSTOM_BUTTON);
#endif /* USE_CUSTOM_BUTTON */
/*******************************************************************************/

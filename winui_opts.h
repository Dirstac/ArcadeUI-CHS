...
//缘来是你
#define MUIOPTION_IPS_DIRECTORY					"ips_directory"		// IPS
...
#define MUIOPTION_USECHINESE_GAMELIST			"Chinese GAME List"
...
//缘来是你
const char* GetIpsDir(void);		// IPS
void SetIpsDir(const char* path);	// IPS

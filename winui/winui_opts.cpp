...
//================================= 缘来是你 =============================>>>
	...
	{ nullptr,								nullptr,	core_options::option_type::HEADER, "中文游戏列表" },
...
void OptionsInit(void)
{
	...
	core_opts.add_entries(ips_option_entries);	// IPS
...
//	opts.set_value(OSDOPTION_GLSLPATH, GetGLSLDir(), OPTION_PRIORITY_CMDLINE);
	...
	//缘来是你
	opts.set_value(OPTION_IPSPATH, GetIpsDir(), OPTION_PRIORITY_CMDLINE);	// IPS

...
#ifdef _M_X64
#define MAMEUINAME			"ExARCADE64"
#else
#define MAMEUINAME			"ARCADE32"
#endif
#define MAMENAME			"MAME"

#define SEARCH_PROMPT		"<在此处搜索>"
...
const char *funcGetParentName(const char *name);	//缘来是你	作弊替换UI版										
...
char *GetGameManufactureByIndex(int nIndex, bool bUse);	//Gaston900

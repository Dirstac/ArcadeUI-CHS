...
#define OPTION_60FPS        		"Frame_60fps"	//缘来是你
...
public:
	...
	// core misc options
	bool skip_crc_check() const { return bool_value(OPTION_SKIP_CRC_CHECK); }	//缘来是你 CRC
	...
	bool Frame_60fps() const { return bool_value(OPTION_60FPS); }	//缘来是你

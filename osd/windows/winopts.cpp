...
options_entry const f_win_option_entries[] =
{
	...
	{ WINOPTION_HLSL_ENABLE";hlsl",                             "0",                 core_options::option_type::BOOLEAN,    "启用 HLSL 后处理（需要 PS3.0）" },
	...
	{ WINOPTION_TRIPLEBUFFER ";tb",                   "0",        core_options::option_type::BOOLEAN,    "启用三重缓冲" },
...
/*************** eziochiu 添加 IPS *****************/
	...
	{ OPTION_IPS,                                     nullptr,    core_options::option_type::STRING,     "以逗号分隔的要应用的 IPS 补丁列表" },
/**************************************************/
	{ nullptr }
};

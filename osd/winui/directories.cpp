...
{
	{ "游戏(ROMs)",                   GetRomDirs,         SetRomDirs,         true,  DIRDLG_ROM },
	{ "游戏声音采样(Samples)",                GetSampleDirs,      SetSampleDirs,      true,  0 },
	{ "装饰预览图(Artwork Previews)",       GetArtworkDir,      SetArtworkDir,      true,  0 },
	{ "装饰图(Artworks)",               GetArtDir,          SetArtDir,          true,  0 },
	{ "音频(Audios)",                 GetAudioDir,        SetAudioDir,        false, 0 },
	{ "BGFX 效果(BGFX chains)",            GetBGFXDir,         SetBGFXDir,         false, 0 },
	{ "首领(Bosses)",                 GetBossesDir,       SetBossesDir,       true,  0 },
	{ "机台(Cabinets)",               GetCabinetDir,      SetCabinetDir,      true,  0 },
	{ "CHD 差异档(CHD Diffs)",              GetDiffDir,         SetDiffDir,         false, 0 },
	{ "游戏作弊(Cheats)",                 GetCheatDir,        SetCheatDir,        true, 0 },
	{ "配置(Config)",                 GetCfgDir,          SetCfgDir,          false, 0 },
	{ "机台面板(Control Panels)",         GetControlPanelDir, SetControlPanelDir, true,  0 },
	{ "控制器(Controllers)",            GetCtrlrDir,        SetCtrlrDir,        false, 0 },
	{ "十字光标(Crosshairs)",             GetCrosshairDir,    SetCrosshairDir,    false, 0 },
	{ "结局(Ends)",                   GetEndsDir,         SetEndsDir,         true,  0 },
	{ "外部数据文件(External Datafiles)",     GetDatsDir,         SetDatsDir,         false, 0 },
	{ "广告图(Flyers)",                 GetFlyerDir,        SetFlyerDir,        true,  0 },
	{ "分类(Folders)",                GetFolderDir,       SetFolderDir,       false, 0 },
	{ "字体(Fonts)",                  GetFontDir,         SetFontDir,         false, 0 },
	{ "游戏结束(Game Overs)",             GetGameOverDir,     SetGameOverDir,     true,  0 },
//	{ "GLSL shaders",           GetGLSLDir,         SetGLSLDir,         false, 0 },
	{ "HLSL 文件(HLSL files)",             GetHLSLDir,         SetHLSLDir,         false, 0 },
	{ "游戏指南(How Tos)",                GetHowToDir,        SetHowToDir,        true,  0 },
	{ "图标(Icons)",                  GetIconsDir,        SetIconsDir,        true, 0 },
	{ "录像文件(Input Recordings)",       GetInpDir,          SetInpDir,          false, 0 },
	{ "语言(Languages)",              GetLanguageDir,     SetLanguageDir,     false, 0 },
	{ "商标(Logos)",                  GetLogoDir,         SetLogoDir,         true,  0 },
	{ "LUA 插件(LUA plugins)",            GetPluginsDir,      SetPluginsDir,      false, 0 },
	{ "游戏手册(Manuals (PDF))",          GetManualsDir,      SetManualsDir,      false, 0 },
	{ "贴图(Marquees)",               GetMarqueeDir,      SetMarqueeDir,      true,  0 },
	{ "存储器(NVRAMs)",                 GetNvramDir,        SetNvramDir,        false, 0 },
	{ "电路板(PCBs)",                   GetPcbDir,          SetPcbDir,          true,  0 },
	{ "游戏存档(SaveStates)",             GetStateDir,        SetStateDir,        false, 0 },
	{ "得分(Scores)",                 GetScoresDir,       SetScoresDir,       true,  0 },
	{ "选角(Selects)",                GetSelectDir,       SetSelectDir,       true,  0 },
	{ "截图(Snapshots)",              GetImgDir,          SetImgDir,          true , 0 },
	{ "标题图(Titles)",                 GetTitlesDir,       SetTitlesDir,       true,  0 },
	{ "对战(Versus)",                 GetVersusDir,       SetVersusDir,       true,  0 },
	{ "演示视频(Videos and Movies)",      GetVideoDir,        SetVideoDir,        false, 0 },
	{ NULL }
};
